...
;(function () {
  ...
  function onSubmit (e) {
    ...
    resultsEl.innerHTML = '<p style="width: 100%; text-align:center;">Waiting for results...</p>'
  ...
  function waitForChecks () {
    ...
    resultsEl.innerHTML = '<p class="results-entry"><span class="results-title">Bits/sec:</span><span>' + bps + '</span></p>' +
      '<p class="results-entry"><span class="results-title">Kb/sec:</span><span>' + kbps + '</span></p>' +
      '<p class="results-entry"><span class="results-title">Mb/sec:</span><span>' + mbps + '</span></p>' +
      '<br/>' +
      '<p class="results-entry"><span class="results-title">Bytes/sec:</span><span>' + byps + '</span></p>' +
      '<p class="results-entry"><span class="results-title">KB/sec:</span><span>' + kbyps + '</span></p>' +
      '<p class="results-entry"><span class="results-title">MB/sec:</span><span>' + mbyps + '</span></p>'
  }
})()
